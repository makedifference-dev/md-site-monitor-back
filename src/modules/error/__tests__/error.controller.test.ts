...
import {
  ...
  NotFoundError,
  InternalError,
} from '@/modules/error/error.contract';
...
describe('ErrorController', () => {
  ...
  describe('handleError', () => {
    ...
    it('should use default 500 when statusCode is missing', () => {
      const apiError = {
        error: 'INTERNAL_ERROR',
        message: 'Something bad',
      } as any; // deliberately without statusCode
  ...
  describe('isApiError (internal)', () => {
    it('returns false for non-object values', () => {
      // Access private method for coverage of fallback branch
      const result = (errorController as any).isApiError(null);
