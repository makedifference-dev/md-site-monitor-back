...
describe('AuthMiddleware', () => {
  ...
  const MockedAuthService = AuthService as unknown as jest.MockedClass<
    typeof AuthService
  >;
  ...
  describe('requireRole', () => {
    ...
    it('uses default ErrorService when not provided in constructor', () => {
      // Instantiate without passing errorService to cover constructor branch
      const mw = new AuthMiddleware();
      const handler = mw.requireRole(['ADMIN']);
