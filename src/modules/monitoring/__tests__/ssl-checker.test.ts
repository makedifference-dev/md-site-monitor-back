...
describe('SSLChecker', () => {
  ...
  describe('checkSSLCertificate', () => {
    ...
    it('should handle missing certificate when undefined', async () => {
      mockSocket.getPeerCertificate.mockReturnValue(undefined);
  ...
  describe('catch path coverage for URL parsing', () => {
    afterEach(() => {
      jest.resetModules();
      jest.clearAllMocks();
    });

    it('returns error message when URL constructor throws Error instance', async () => {
      await new Promise<void>(resolve => {
        jest.isolateModules(async () => {
          ...
          const {
            SSLChecker: LocalChecker,
          } = require('../../modules/monitoring/ssl-checker');
          const res = await LocalChecker.checkSSLCertificate('anything');
